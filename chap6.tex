...
\secrel{6.4 CUTTERS FOR MILLING}\secdown
...
If a fly cutter is lowered directly into a flat surface. a circle would be cut
...
\secrel{Inserted tip fly cutter}
...
More detail on end mills can be found on page 201 in the instructions for
...
\secrel{Special shaped milling cutters}
...
\secrel{CUTTING TOOL HOLDERS FOR MILLING}\secdown

\secrel{End mill holders}
...
\secrel{Boring head and boring tools}
...
\secrel{USING MILLING CUTTERS}\secdown
...
\secrel{Comparing "Conventional"\ and "Climb"\ milling}

To explain the difference, the best analogy 1 can come up with would be using a
...
\secrel{Despite its drawbacks, climb milling can give a better finish}

Climb milling can create a better finish in two ways. First, the lightest part
...
\secrel{An example of a climb milling cut}
